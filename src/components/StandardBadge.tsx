...
const StandardBadge: React.FC<StandardBadgeProps> = ({ text = "Standard", className }) => {
  return (
    <div 
      style={{ fontFamily: "'Shippori Antique B1', sans-serif", alignItems: 'center', justifyContent: 'center', background: '#242424'}}
